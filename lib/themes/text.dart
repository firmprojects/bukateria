...
TextStyle body2 = GoogleFonts.montserrat(fontSize: 18, color: dark);

TextStyle body3 = GoogleFonts.montserrat(fontSize: 16, color: dark);

TextStyle body4 = GoogleFonts.montserrat(fontSize: 14, color: dark);

TextStyle body5 = GoogleFonts.montserrat(fontSize: 12, color: dark);
